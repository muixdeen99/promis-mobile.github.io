...
class BayaranDepositKuartersPage extends StatefulWidget {
  const BayaranDepositKuartersPage({super.key});

  @override
  State<BayaranDepositKuartersPage> createState() => _BayaranDepositKuartersPageState();
}

class _BayaranDepositKuartersPageState extends State<BayaranDepositKuartersPage> {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                _buildDepositCard('BPH/IR/TK/2025/000003', '01/01/2025', '111111', 'Bayaran Deposit untuk Kuarters A', '100.00'),
                const SizedBox(height: 10),
                _buildDepositCard('BPH/IR/TK/2025/000004', '02/01/2025', '222222', 'Bayaran Deposit untuk Kuarters B', '150.00'),
              ],
            ),
          ),
