...
class KesalahanPage extends StatefulWidget {
  const KesalahanPage({super.key});

  @override
  State<KesalahanPage> createState() => _KesalahanPageState();
}

class _KesalahanPageState extends State<KesalahanPage> {
  List<dynamic> kesalahan = [];
  String? userId;
  ...
  Future<void> _fetchKesalahan(String userId) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data['data'] != null) {
        setState(() {
          kesalahan = response.data['data'];
        });
        print('Data: $kesalahan');
      } else {
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            Column(
                              children: [
                                kesalahan.isNotEmpty
                                    ? ListView.builder(
                                        shrinkWrap: true,
                                        physics: const NeverScrollableScrollPhysics(),
                                        itemCount: kesalahan.length,
                                                ...
                                                child: Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        Text(
                                                          '${kesalahan[index]['noRujukanOperasi']}',
                                                      ...
                                                      children: [
                                                        TableRow(
                                                          children: [
                                                            ...
                                                            Text(
                                                              '${kesalahan[index]['keteranganKawasanKuarters']}',
                                                              style: const TextStyle(
                                                                  color: Colors
                                                                      .grey,
                                                                  fontWeight:
                                                        ...
                                                        TableRow(
                                                          children: [
                                                            ...
                                                            Text(
                                                              '${kesalahan[index]['keteranganOperasi']}',
                                                              style: const TextStyle(
                                                                  color: Colors
                                                                      .grey,
                                                                  fontWeight:
                                                        ...
                                                        //     ),
                                                        //     Text(
                                                        //       '${kesalahan[index]['tarikhKemaskini'] ?? '-'}',
                                                        //       style: TextStyle(
                                                        //           color: Colors
                                                        //               .grey,
                                                        //           fontWeight:
