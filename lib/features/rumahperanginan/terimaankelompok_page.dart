...
class TerimaankelompokPage extends StatefulWidget {
  const TerimaankelompokPage({super.key});

  @override
  State<TerimaankelompokPage> createState() => _TerimaankelompokPageState();
}

class _TerimaankelompokPageState extends State<TerimaankelompokPage> {
                    ...
                    Infocard(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                  builder: (context) => TerimaankelompokDetailsPage(),
                ),
                        );
                      },
                    ),
